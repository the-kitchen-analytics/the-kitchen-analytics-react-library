...
const EditUserForm = ({
  ...
  const {
    settings: { controlsSize, accentColor }
  } = useUserSettings()

  const { displayName, email, workerCategory, description } = formData
  ...
  return (
    <Form onSubmit={handleSubmit} loading={isLoading} size={controlsSize}>
      <Form.Input
        required
        name='displayName'
        type='text'
